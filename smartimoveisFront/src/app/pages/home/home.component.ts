...
export class HomeComponent implements OnInit {
  ...
  public getProperties(){  
    ...
    this.listProperties = JSON.parse(properties);
      ...
      this.listProperties.forEach(async property => {
        await property.gallery.forEach(async image => {
        ...
        await property.plans.forEach(async plan =>  plan.image = await this.addWaterMark(plan.image))
      });
